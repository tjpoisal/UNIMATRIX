      ...
      <div className="w-full max-w-md">
        <div className="backdrop-blur-xl bg-[#111827]/80 border border-[#334155]/30 rounded-2xl p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[#F1F5F9] mb-2">Name</label>
          ...
          <div className="text-center pt-4 border-t border-[#334155]/30">
            <p className="text-[#94A3B8]">
              ...
              <a href="/auth/login" className="text-[#00F5FF] hover:text-[#00D9FF] font-medium transition-colors">Sign in</a>
            </p>
          </div>
        </div>
      </div>
